...
**Modulation** is a GEGL-based filter for GIMP that applies a **Directional Frequency Modulation (FM)** effect to images. It transforms image data into frequency-modulated lines, creating a retro signal processing, glitch-art, or "CRT scanline" aesthetic.

Written in C as a high-performance GEGL operation, it utilizes prefix-sum optimization to render complex line integral effects in real-time.
...
Source File: `modulation.c`
Plugin File: `modulation.dll`
